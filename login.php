...
.btn{
  ...
  <div align="center">
	...
	<br><br><br>
  <h1>MADRASAH ALIYAH WADIABERO</h1>
	<br \><br \>
			<div class="container">
					<div style="color:white">
					<label>Login</label><br \>
					<label>	SELAMAT DATANG DI MENI LOGIN. SILAHKAN BUAT AKUN JIKA BELUM MEMILIKI AKUN</label><br \>
					<label>Silahkan Masukkan Email dan Password Anda Untuk Login</label>
					</div>
                <form method="post">
